(function ($) {
    ...
    */
	...
	var WidgetTestimonialHandler = function ($scope, $) { 
		...
		var testmimonial_1 = new Swiper(".testmimonial-1", {
			slidesPerView: 1,
			spaceBetween: 30,
			freeMode: true,
			pagination: {
		...
		var testmimonial_2 = new Swiper(".testmimonial-2", {
			slidesPerView: 1,
			spaceBetween: 30,
			freeMode: true,
			pagination: {
	...
	$( window ).on( 'elementor/frontend/init', function() {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/zt-testimonial.default', WidgetTestimonialHandler );
	} );
