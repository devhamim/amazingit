...
<div class="container-fluid flex-grow-1 container-p-y">
    <h4 class="font-weight-bold py-3 mb-0">Social</h4>
                ...
                <div class="card-body">
                    <div class="row align-items-center m-l-0">
                        ...
                        <div class="col-sm-6 text-right">
                            <button class="btn btn-success btn-sm mb-3 btn-round" data-toggle="modal" data-target="#user_register"><i class="feather icon-plus"></i>Add Social</button>
                        </div>
                    </div>
...
@if ($errors->has('name')||$errors->has('status'))
                ...
                <div class="modal-body">
                    <form method="POST" action="{{route('courire.store')}}">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="floating-label" for="name">Social Name *</label>
