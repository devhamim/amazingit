        ...
        <div class="dashboard-ecommerce">
            <div class=" dashboard-content ">
                        ...
                        <div class="page-header">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="filter row">
                                    ...
                                    <div class="col-lg-2">
                                        @if ($order_status->first())
                                            <form action="{{ route('user.orders.view.status',$order_status->first()->status) }}" method="GET">
                                        @else
                                            <form action="{{ route('user.orders.view.status',$order_status) }}" method="GET">
                                        @endif
                                            <!-- ... (other form fields) -->
                    ...
                    <div class="col-md-4 col-4 mt-md-0 mt-2">
                        <form action="{{ route('orders.courier.list') }}" method="get" class="form-inline float-md-right">
                            <div class="form-group">
                                ...
                                <a href="{{route('user.order.view')}}" class="btn btn-secondary mx-2">Reset</a>
                            </div>
                        </form>
                    </div>
                ...
                <div class="row mb-md-4 mb-3">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6 ">
                        <a href="{{ route('user.orders.view.status', 0) }}">
                            <div class="card border-3 border-top border-top-success">
                                <div class="card-body">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6 ">
                        <a href="{{ route('user.orders.view.status', 2) }}">
                            <div class="card border-3 border-top border-top-success">
                                <div class="card-body">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6 ">
                        <a href="{{ route('user.orders.view.status', 3) }}">
                            <div class="card border-3 border-top border-top-success">
                                <div class="card-body">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6 ">
                        <a href="{{ route('user.orders.view.status', 4) }}">
                            <div class="card border-3 border-top border-top-success">
                                <div class="card-body">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6 ">
                        <a href="{{ route('user.orders.view.status', 5) }}">
                            <div class="card border-3 border-top border-top-success">
                                <div class="card-body">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6 ">
                        <a href="{{ route('user.orders.view.status', 6) }}">
                            <div class="card border-3 border-top border-top-success">
                                <div class="card-body">
                        ...
                        <div class="card ">
                            <div class="card-body table-responsive">
                                <table id="report-table" class="table table-bordered table-striped text-center">
                                    ...
                                    <tbody>
                                        @foreach ($order_status as $sl=>$order)
                                        <tr id="tr_{{ $order->id }}">
                                            <td>
