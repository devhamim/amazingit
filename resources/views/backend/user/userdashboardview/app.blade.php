                ...
                <ul class="sidenav-inner py-1">
                    ...
                    <li class="sidenav-item ">
                        @php
                            $id = session('user_id');
                        @endphp
                        <a href="{{route('user.home.view', $id)}}" class="sidenav-link">
                            <i class="sidenav-icon feather icon-home"></i>
                            <div>Dashboard</div>
                        </a>
                    </li>
                    <li class="sidenav-item">
                        <a href="{{route('user.customer.list.view')}}" class="sidenav-link">
                            <i class="sidenav-icon feather icon-user"></i>
                            <div>Customer</div>
                        </a>
                    </li>
                    <li class="sidenav-item">
                        <a href="{{route('user.order.view')}}" class="sidenav-link">
