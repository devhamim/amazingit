...
<div class="container-fluid flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between">
        ...
        {{-- <form action="{{ route('return.home') }}" method="GET">
            <button type="submit" class="btn btn-danger">Return Admin</button>
        </form> --}}
        <a href="{{ route('return.home') }}" class="btn btn-danger">Return Admin</a>
